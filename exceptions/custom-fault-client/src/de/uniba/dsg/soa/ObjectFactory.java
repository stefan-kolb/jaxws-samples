...
public class ObjectFactory {
    ...
    private final static QName _VerificationFault_QNAME = new QName("http://soa.dsg.uniba.de/", "VerificationFault");
    ...
    /**
     * Create an instance of {@link VerificationFaultBean }
     * 
     */
    public VerificationFaultBean createVerificationFaultBean() {
        return new VerificationFaultBean();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link VerificationFaultBean }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://soa.dsg.uniba.de/", name = "VerificationFault")
    public JAXBElement<VerificationFaultBean> createVerificationFault(VerificationFaultBean value) {
        return new JAXBElement<VerificationFaultBean>(_VerificationFault_QNAME, VerificationFaultBean.class, null, value);
    }
